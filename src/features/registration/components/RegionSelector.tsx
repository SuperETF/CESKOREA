...
const DISTRICTS: Record<string, string[]> = {
  ...
  "인천광역시": ["강화군", "계양구", "남동구", "동구", "미추홀구", "부평구", "서구", "연수구",
    "옹진군", "중구"],
  ...
  "강원도": ["강릉시", "고성군", "동해시", "삼척시", "속초시", "양구군", "양양군", "영월군",
    ...
    "화천군", "횡성군"],
  "충청북도": ["괴산군", "단양군", "보은군", "영동군", "옥천군", "음성군", "제천시", "증평군",
    "진천군", "청주시", "충주시"],
...
export default function RegionSelector({
  ...
  return (
    <div className="space-y-4 bg-white rounded-xl shadow-sm p-5 mb-6">
      {/* 시/도 */}
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">시/도 선택</label>
        <select
          value={region}
          onChange={(e) => {
            onRegionChange(e.target.value);
            onDistrictChange(""); // 시/도 바꾸면 구/군 초기화
          }}
      ...
      {/* 구/군 */}
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">구/군 선택</label>
        <select
          value={district}
